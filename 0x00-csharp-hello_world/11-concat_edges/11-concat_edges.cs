...
class Program
{
	static void Main(string[] args)
	{
		...
		str = str.Substring(str.IndexOf("object-oriented"), "object-oriented".Length) + " " + str.Substring(str.IndexOf("programming"), "programming".Length) + " " + str.Substring(str.IndexOf("in"), "in".Length) + " " + str.Substring(str.IndexOf("C#"), "C#".Length);
