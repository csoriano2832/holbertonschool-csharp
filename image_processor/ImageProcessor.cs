...
/// <summary>Represents an image processor.</summary>
class ImageProcessor
{
    /// <summary>Creates inverted images.</summary>
    ...
    /// <summary>Creates grayscale images.</summary>
    ...
    /// <summary>Creates black and white images.</summary>
    ...
    /// <summary>Creates thumbnail images.</summary>
    ...
    /// <summary>Processes files in parallel.</summary>
    ...
    /// <summary>Creates locked bitmaps for images.</summary>
    /// <param name="f">The processing function.</param>
